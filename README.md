...
### [Clouma](https://clouma.com) — Compliance & Security Platform
Multi-tenant SaaS platform with two product surfaces:
- **Clouma Proof** — GRC platform automating compliance evidence collection and control mapping across SOC 2, HIPAA, PCI DSS, ISO 27001, NIST CSF, NIST 800-171, CMMC, and FedRAMP
- **Clouma Shield** — CNAPP (cloud-native application protection) for continuous security findings and posture management, currently in development
- Multi-cloud security scanning across AWS, Azure, GCP, OCI, and Kubernetes
